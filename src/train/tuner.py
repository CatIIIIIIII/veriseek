...
from src.data import get_template_and_fix_tokenizer
from src.extras.callbacks import LogCallback
from src.extras.logging import get_logger
from src.hparams import get_infer_args, get_train_args
from src.model import load_model, load_tokenizer
from .pt import run_pt
from .ppo_compiler import run_ppo_compiler
...
def run_exp(args: Optional[Dict[str, Any]] = None, callbacks: List["TrainerCallback"] = []) -> None:
    ...
    elif finetuning_args.stage == "ppo_compiler":
        run_ppo_compiler(model_args, data_args, training_args, finetuning_args, generating_args, callbacks)
    else:
